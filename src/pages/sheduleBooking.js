...
function sheduleBooking(props) {
    ...
    const getInstructor = async (id) => {
        props.loader(true);
        let url = `booking/getinstructers/${id}`;
        Api("get", url, router).then(
            (res) => {
                props.loader(false);
                console.log("abcd", res?.data);
    ...
    const onAssign = async (id) => {
        ...
        let url = `booking/assignInstructer`;
        ...
        return (
            <div className="flex cursor-pointer  text-black items-center justify-evenly py-2 rounded-[10px] mr-[10px]"
                onClick={() => {
                    ...
                    setOpen(true)
                    getInstructor(row.original._id)
                }}
            >
            ...
            <div className=" h-full">
                ...
                <div className="bg-white md:pb-32 px-1 rounded-[12px] h-full overflow-y-scroll scrollbar-hide overflow-scroll pb-28 mt-3">
                    <div className="bg-[#CFE0E54D] px-4 min-h-screen rounded-[24px]">
                        <p className="text-black text-[20px] pt-4"> Shedule Booking Details</p>
                        <div className="-mt-4">
                            {instructorList.length > 0 ? (
                                ...
                                <div className="flex flex-col items-center justify-center py-10 min-h-[600px] text-gray-500">
                                    ...
                                    <p className="text-lg font-medium">No Shedule Booking found</p>
                            ...
                            <div className="bg-gray-50 px-6 py-6 border-b border-gray-200">
                                <div className="flex items-center justify-between relative">
                                    ...
                                    <div className="text-right">
                                        <button className="cursor-pointer text-sm bg-custom-sky py-2 px-4 rounded-md text-white"
                                            onClick={() => setIsOpen(true)}
                                        >Assign instructer</button>
                                    </div>
                                    ...
                                    {isOpen && (
                                        <div className="fixed inset-0 bg-black/30 flex items-center justify-center z-50">
                                            <div className="bg-white rounded-2xl shadow-2xl w-96 p-6 border border-custom-sky">
                                                {/* Heading */}
                                                <h2 className="text-lg font-semibold text-custom-sky mb-4 border-b pb-2">
                                                    Select Instructor
                                                </h2>
                                                ...
                                                <select
                                                    ...
                                                    className="w-full border border-custom-sky rounded-md p-2 mb-4 text-gray-700 focus:outline-none focus:ring-2 focus:ring-custom-sky"
                                                >
                                                ...
                                                <div className="flex justify-end space-x-3">
                                                    ...
                                                    <button
                                                        ...
                                                        className="px-4 py-2 bg-custom-sky text-white rounded-md shadow hover:bg-sky-500 transition cursor-pointer"
                                                    >
                                                        Assign
                                                    </button>
                                                </div>
                                ...
                                <p
                                    ...
                                    className="text-black text-2xl cursor-pointer absolute right-4 top-2"
                                > <RxCross2 /></p>
                            </div>
                                ...
                                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 divide ">
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        <div className="flex">
                                            ...
                                            <span className="text-gray-600">{popupData.total}</span>
                                        </div>
                                        <div className="flex">
...
export default isAuth(sheduleBooking);
